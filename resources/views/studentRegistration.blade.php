...
<div id="wrapper">
            ...
            <div class="row clearfix">
                <div class="col-1">
                    ...
                    <div id="logo">
                        ...
                        <img src="images/banner-images/banner-image-1.jpg" id="banner-logo" alt="Landing Page"/>
                        <!--End of Banner Logo-->
    ...
    <main id="content">
        ...
        <!--Pricing Tables     .remove secondary-class from below class section to eradicate the dark background-->
        <section id="pricing" class="text-center scrollto clearfix ">
            <div class="row clearfix">
        ...
        <!--Testimonials-->
        <aside id="testimonials" class="secondary-color scrollto text-center" data-enllax-ratio=".2">
            ...
            <div class="row clearfix">
                ...
                <blockquote class="col-3 testimonial classic">
                    ...
                    <q>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                        labore
                        et dolore magna aliqua</q>
                    <footer>Soumik Sarker - Happy Customer</footer>
                </blockquote>
                <!-- End of Testimonial-->
                ...
                <blockquote class="col-3 testimonial classic">
                    ...
                    <q>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod stempor incididunt ut
                        labore
                        et dolore magna aliqua</q>
                    <footer>Ali Ahsan Md. Linkon- Happy Customer</footer>
                </blockquote>
                <!-- End of Testimonial-->
                ...
                <blockquote class="col-3 testimonial classic">
                    ...
                    <q>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                        labore
                        et dolore magna aliqua</q>
                    <footer>Md. Mahir Labib - Happy Customer</footer>
                </blockquote>
                <!-- End of Testimonial-->
...
<script src="js/ProfileTeacher.js"></script>
