...
<!--Meta Keywords and Description  I CHANGE HERE-->
<meta name="keywords" content="">
<meta name="description" content="">
<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no"/>
<!--Meta Keywords and Description  I CHANGE HERE-->

<!--Favicon I CHANGE HERE-->
<link rel="shortcut icon" href="{{ url('images') }}/favicon.ico" title="Favicon"/>
<!--Favicon I CHANGE HERE-->


<!-- Animate CSS CHANGE HERE-->
<link href="{{ url('css') }}/animate.css" rel="stylesheet" type="text/css">


<!-- Tell the browser to be responsive to screen width -->
<!-- <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport"> CHANGE HERE-->
<!-- Font Awesome -->
<!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"> CHANGE HERE-->
<!-- Ionicons -->
<!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css"> CHANGE HERE -->
