                    ...
                    <nav id="nav-main">
                      <aside>
                        <ul>
                            ...
                            <li>
                                <a href="http://localhost/quiz_semi/public/login">Log In</a>
                            </li>
                        </ul>
                        </aside>
                    </nav>
...
<div class="slider">
    <div class="thumbs">
     <!--  <div class="close">+</div>  -->
      <div class="first-modal-contents">
...
<!--         @if(count($errors) > 0)
        ...
        @endif -->
         ...
         <form id ="form1" action="insert" method="post">
            ...
            <input type="submit" name="submit" value="Submit" onclick="window.location='{{ url("http://localhost/quiz_semi/public/againStart") }}'">
  ...
  <h4>Choose your account type</h4>
      ...
      <!--           @if(count($errors) > 0)
        ...
        <form id ="form2" action="" method="post">
            ...
            <input id="Accountq3" type="text" placeholder="" name="id3">
            <input id="Accountq4" type="text" placeholder="" name="id4">
