...
class LessonsController extends Controller
{
    ...
    public function create()
    {
        ...
        $courses = \App\Course::ofTeacher()->get()->pluck('course_code', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
    ...
    public function show($id)
    {
        ...
        $courses = \App\Course::get()->pluck('course_code', 'id')->prepend(trans('quickadmin.qa_please_select'), '');$exams = \App\Exam::where('lesson_id', $id)->get();

        $lesson = Lesson::findOrFail($id);

        return view('admin.lessons.show', compact('lesson', 'exams'));
    }
