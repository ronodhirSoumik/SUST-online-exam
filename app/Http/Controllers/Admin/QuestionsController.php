...
class QuestionsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $question_options = \App\QuestionOption::where('question_id', $id)->get();$exams = \App\Exam::whereHas('questions',
        ...
        return view('admin.questions.show', compact('question', 'question_options', 'exams'));
    }
